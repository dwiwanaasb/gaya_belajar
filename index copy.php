...
<body>
    ...
    if (isset($_POST["kirim-ques"])) {
        ...
        $solusiVisual = '<div style="text-align: left;">1. Melakukan pembelajaran dengan materi pembelajaran yang sudah di visualisasikan dalam bentuk video.<br>2. Membaca buku yang memiliki lebih banyak gambar.</div>';
        $solusiAuditori = '<div style="text-align: left;">1. Belajar sambil mendengarkan lagu yang disukai anak.<br>2. Menemani anak belajar, sehingga anak dan orang tua bisa berdiskusi secara langsung</div>';
        $solusiKinestetik = 'Dapat mengajak anak untuk segera mempraktikan materi yang dipelajari';

        if ($persenVisual > $persenAuditori && $persenVisual > $persenKinestetik) {
            $hasil = "Hasil evaluasi gaya belajar siswa dengan nama " . $nama . ", usia " . $usia . " tahun adalah " . $persenVisual . " % Visual, " . $persenAuditori . " % Auditori, dan " . $persenKinestetik . " % Kinestetik. <br><br> <b>Solusi:</b> <br>" . $solusiVisual;
        } else if ($persenAuditori > $persenVisual && $persenAuditori > $persenKinestetik) {
            $hasil = "Hasil evaluasi gaya belajar siswa dengan nama " . $nama . ", usia " . $usia . " tahun adalah " . $persenVisual . " % Visual, " . $persenAuditori . " % Auditori, dan " . $persenKinestetik . " % Kinestetik. <br><br> <b>Solusi:</b> <br>" . $solusiAuditori;
        } else if ($persenKinestetik > $persenVisual && $persenKinestetik > $persenAuditori) {
            $hasil = "Hasil evaluasi gaya belajar siswa dengan nama " . $nama . ", usia " . $usia . " tahun adalah " . $persenVisual . " % Visual, " . $persenAuditori . " % Auditori, dan " . $persenKinestetik . " % Kinestetik. <br><br> <b>Solusi:</b> <br>" . $solusiKinestetik;
        }
